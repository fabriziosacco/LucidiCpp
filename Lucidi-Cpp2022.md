...
## Lo stesso in C++
```cpp
#include <iostream> // OnLineCompiler:[https://www.onlinegdb.com/online_c++_compiler]
using namespace std;
int main()
{
...
#include <iostream> // OnLineCompiler:[https://codeboard.io/projects/302722]
#include <cstdio>
#include <cstdlib>
using namespace std;
...
#include <iostream> // OnLineCompiler:[https://codeboard.io/projects/302726]
#include <cstdio>
#include <cstdlib>
using namespace std;
...
int main() { // [https://codeboard.io/projects/302726]
        int scelta;
        cout << "1=float,2=libro,3=data ->";
        cin >> scelta;
        if (scelta==1)
...
```cpp
#include <iostream> // OnLineCompiler:[https://codeboard.io/projects/302729]
#include <vector>
using namespace std;
